    ...
    <div className="flex bg-[var(--bg-primary)]">
      ...
      <main className="flex-1">
        <div>
          ...
          <div className="lg:hidden border border-[var(--border-light)]/90 bg-[var(--bg-secondary)]/50 flex justify-center mb-6">
            <button
              onClick={openMobileFilter}
              className="flex items-center gap-2 px-5 py-2 w-1/2 border-r border-[var(--border-light)]/90 justify-center text-[var(--text-secondary)] "
            >
            ...
            <button
              onClick={openMobileFilter}
              className="flex items-center gap-2 px-5 py-2 w-1/2 justify-center text-[var(--text-secondary)] "
            >
              <ArrowDownUp size={18} />
              Short
            </button>
